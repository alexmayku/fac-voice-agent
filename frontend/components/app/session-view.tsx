...
export const SessionView = ({
  ...
  return (
    <section className="relative flex h-svh w-svw flex-col md:flex-row" {...props}>
      ...
      <div className="relative z-10 flex flex-1 flex-col border-t border-[#e5e7eb] bg-[rgba(0,0,0,0.02)] md:h-full md:max-h-svh md:w-[420px] md:flex-none md:border-t-0 md:border-l lg:w-[460px]">
        {/* Transcript header */}
